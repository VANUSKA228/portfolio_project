...
- Полнофункциональная панель администратора (удаление, редактирование, impersonation)
- Публичные профили пользователей
- Живой поиск пользователей
- Массовые действия (удаление нескольких пользователей)
- Логирование действий администратора
- Кастомный дизайн с переключателем тем
- Команда для автосоздания суперпользователя

## 🔮 Планируется

- Личная информация пользователя (фото, описание)
- Интеграция с GitHub OAuth
- Пресеты портфолио (сетка, Bento, витрина)
- Подгрузка проектов из GitHub